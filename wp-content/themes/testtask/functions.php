...
function testtask_scripts()
{
    ...
    wp_enqueue_script('mobile-menu-script', get_template_directory_uri() . '/assets/js/mobile-menu.js', array(), null, true);
    wp_enqueue_script('search-overlay-script', get_template_directory_uri() . '/assets/js/search-overlay.js', array(), null, true);
